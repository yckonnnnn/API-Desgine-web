...
export const Route = createFileRoute("/console/overview")({ component: Overview });
...
function OverviewUsd({ cents }: { cents: number }) {
  const amount = (cents / 100).toLocaleString("en-US", {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2,
  });
  return (
    <span className="overview-usd" aria-label={`$${amount}`}>
      <span className="overview-usd-symbol" aria-hidden="true"><span>S</span><i /></span>
      <span>{amount}</span>
    </span>
  );
}
          ...
          <div className="overview-dashboard-grid">
            ...
            <div className="overview-middle-stack">
              ...
              <div className="overview-mini-grid ops-rise" style={rise(4)}>
                <section className="overview-mini-card">
                  ...
                  <strong><OverviewUsd cents={data.todaySpendCents} /></strong>
            ...
            <div className="overview-right-stack">
              <section className="overview-balance overview-card ops-rise" style={rise(3)}>
                ...
                <strong><OverviewUsd cents={data.balanceCents} /></strong>
